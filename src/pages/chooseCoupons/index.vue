        ...
        <div class="tm-coupon-item">
          ...
          <div class="tm-coupon-right">
            ...
            <div class="tm-right-bottom">
              ...
              <div class="tm-right-btn" :data-coupon="item.money" @click="goUse">立即使用</div>
            </div>
          </div>
        </div>
      </block>
...
export default {
  ...
  methods: {
    goUse(e){
      ...
      wx.redirectTo({url: '/pages/memberPayment/main?coupon='+coupon});
    }
  },
  onLoad(){
    this.coupon=couponData.activeData
  },
  created () {
    // 调用应用实例的方法获取全局数据
